...
<style>
    ...
    .indexbtn {
        background: linear-gradient(to right, green 33.33%, white 33.33%, white 66.66%, green 66.66%);
        color: black;
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 myimgcover ">
                <!-- <img src="images/house1.jpg" class="img-fluid" alt="Image" /> -->

                <!-- <div class="col-lg-2">
                    <h5 class="mt-4">If new register here, signUp Here

                    <a href="landlord_signup_form.php"><button class="btn mybtn btn-success mt-4">Signup</button></a>
                ...
                <h5 >Already Registered,login here
                    <button class="mybtn mt-4 " style="background-color:green; color:white">Login Here</button>
                </h5> -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-3" >
                    ...
                    <span> <b> Already Registered, login here as a landlord</b>  </span>
                      <button class="btn mybtn btn-success btn-sm mt-4 " style=" color:white; border-radius:30%">Landlord Login</button>
             ...
             <div class="col-3" >
                    ...
                    <span> <b> Already Registered, login here as a landlord</b>  </span>
                      <button class="btn mybtn btn-success btn-sm mt-4 " style=" color:white; border-radius:30%">Tenant Login</button>
