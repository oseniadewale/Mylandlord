    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 mt-4">
                ...
                <form action="process/landlord_full_process.php" method="post">
                    ...
                    <div>
                        ...
                        <input type="text" name="landlord_username" class="form-control"
                            value="<?php echo $_SESSION["landlord_username"]; ?>" placeholder="type your username here">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <textarea name="landlord_homeaddress" id="" class="form-control"></textarea>
                        </div>



                        <div style="display: flex; justify-content: center;">
                            <button class="btn btn-success mb-3 mt-3" name="landlord_full_btn" type="submit" style="">Submit</button>
                        </div>
